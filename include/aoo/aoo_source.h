...
AOO_INLINE AooError AooSource_setFormat(AooSource *source, AooFormat *f)
{
    return AooSource_control(source, kAooCtlSetFormat, 0, AOO_ARG(*f));
}

AOO_INLINE AooError AooSource_getFormat(AooSource *source, AooFormatStorage *f)
{
...
AOO_INLINE AooError AooSource_getXRunDetectionk(AooSource *source, AooBool *b)
{
